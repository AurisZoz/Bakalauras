@extends('layout2')
@section('title', 'Reabilitacijos paskyrimas')
@section('content')

<link rel="stylesheet" href="{{ asset('css/appointment.css') }}">

<div class="container">
    <h1><img src="/img/appointment2.png" width="50" height="50" class="me-2 align-middle">Reabilitacijos plano paskyrimas</h1>
    <form action="{{ route('appointment.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select id="user_id" name="user_id" class="form-select" required>
                <option value="" disabled selected>Pasirinkite naudotoją</option>
        ...
        <div class="mb-3">
            ...
            <select id="plan_id" name="plan_id" class="form-select" required>
                <option value="" disabled selected>Pasirinkite planą</option>
        ...
        <div class="mb-3">
            ...
            <textarea id="comments" name="comments" class="form-control" rows="4" placeholder="Įrašykite komentarą"></textarea>
        </div>

        <button type="submit" class="btn btn-primary">Paskirti</button>
    </form>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        userSelect.addEventListener('change', function () {
            ...
            const userSurname = selectedOption.getAttribute('data-surname');
            const userPhone = selectedOption.getAttribute('data-phone');
            userInfo.value = `Vardas: ${userName} ${userSurname}, Tel: ${userPhone}`;
        });
